...
def Appbar(props):
    ...
    return (
        AppBar (props=new_props, elevation=1, children=[
            ...
            Submenu (),
            a (props={'id': 'solu-appbar-icon', 'href': 'https://solu.js.org', 'target': '_blank'}, style={'visibility': 'hidden', 'position': 'absolute', 'right': JSON.fromInteger(0), 'top': JSON.fromInteger(0), 'margin': '15px'}, children=[

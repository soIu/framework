...
var str = ρσ_str, repr = ρσ_repr;;
    ...
    ρσ_modules.watson = {};
    ρσ_modules["watson.teaching"] = {};
    ρσ_modules["watson.confirmation"] = {};
    ρσ_modules["watson.modules"] = {};
    ρσ_modules.modules = {};
    ...
    (function(){
        ...
        function warning(error, offline) {
            if (offline) {
        ...
        if (!warning.__argnames__) Object.defineProperties(warning, {
            __argnames__ : {value: ["error", "offline"]}
        });
        ...
        function ajax(type, dataType, url, data, opts) {
            ...
            return new Promise((function() {
                var ρσ_anonfunc = function (resolve, reject) {
                    ...
                    xhr.onload = function () {
                        configuration.ajax_resolve(resolve, this, opts);
                    };
                    xhr.onerror = function () {
                        configuration.ajax_reject(reject, this, opts);
                    };
...
;
    ...
    (function(){
        ...
        Model.prototype.__super__ = function __super__(method_name) {
            var self = this;
            var method;
            method = (ρσ_expr_temp = env.Model)[(typeof method_name === "number" && method_name < 0) ? ρσ_expr_temp.length + method_name : method_name];
            if (!self._inherit) {
                if (!method) {
                    return function () {
                        return new Promise((function() {
                            var ρσ_anonfunc = function (resolve) {
                                resolve();
                            };
                            if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                                __argnames__ : {value: ["resolve"]}
                            });
                            return ρσ_anonfunc;
                        })());
                    };
                ...
                method = (ρσ_expr_temp = (ρσ_expr_temp = raw_models[ρσ_bound_index(self._inherit, raw_models)])[ρσ_expr_temp.length-1].prototype)[(typeof method_name === "number" && method_name < 0) ? ρσ_expr_temp.length + method_name : method_name];
            }
            return function () {
                var kwargs = arguments[arguments.length-1];
                if (kwargs === null || typeof kwargs !== "object" || kwargs [ρσ_kwargs_symbol] !== true) kwargs = {};
                var args = Array.prototype.slice.call(arguments, 0);
                if (kwargs !== null && typeof kwargs === "object" && kwargs [ρσ_kwargs_symbol] === true) args.pop();
                var original_method, result;
                original_method = self[(typeof method_name === "number" && method_name < 0) ? self.length + method_name : method_name];
                self[(typeof method_name === "number" && method_name < 0) ? self.length + method_name : method_name] = method;
                result = ρσ_interpolate_kwargs.call(self[(typeof method_name === "number" && method_name < 0) ? self.length + method_name : method_name], self[(typeof method_name === "number" && method_name < 0) ? self.length + method_name : method_name], args.concat([ρσ_desugar_kwargs(kwargs)]));
                if (exist(result) && ρσ_equals(type(result), Promise)) {
                    return result.then((function() {
                        var ρσ_anonfunc = function (result) {
                            self[(typeof method_name === "number" && method_name < 0) ? self.length + method_name : method_name] = original_method;
                            return result;
                        };
                        if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
        ...
        if (!Model.prototype.__super__.__argnames__) Object.defineProperties(Model.prototype.__super__, {
            __argnames__ : {value: ["method_name"]}
        });
...
ρσ_unpack = ρσ_unpack_asarray(2, ρσ_unpack);
        ...
        Model.prototype.adapt = function adapt(key, value) {
            ...
            if (ρσ_in((ρσ_expr_temp = self._fields)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key].type, ρσ_list_decorate([ "char", "text" ]))) {
                ...
                if (!checkBase64(value)) {
                    throw new Exception("Not a valid base64");
                }
                ...
                if (!exist(value)) {
                    ...
                    try {
                        ...
                        ρσ_last_exception = ρσ_Exception;
                        {
                            throw new Exception("Can't parse Date");
                        } 
                    }
                } else {
                    throw new Exception("Can't parse Date");
        ...
        Model.prototype.sudo = function sudo(uid) {
            var self = this;
            ...
            return ρσ_interpolate_kwargs.call(self, self.with_context, [ρσ_desugar_kwargs({uid: uid})]);
        };
        if (!Model.prototype.sudo.__argnames__) Object.defineProperties(Model.prototype.sudo, {
            __argnames__ : {value: ["uid"]}
        });
        Model.prototype.with_context = function with_context() {
            ...
            if (kwargs !== null && typeof kwargs === "object" && kwargs [ρσ_kwargs_symbol] === true) args.pop();
            var key, arg;
            var ρσ_Iter23 = ρσ_Iterable(args);
            for (var ρσ_Index23 = 0; ρσ_Index23 < ρσ_Iter23.length; ρσ_Index23++) {
                arg = ρσ_Iter23[ρσ_Index23];
                var ρσ_Iter24 = ρσ_Iterable(arg);
                for (var ρσ_Index24 = 0; ρσ_Index24 < ρσ_Iter24.length; ρσ_Index24++) {
                    key = ρσ_Iter24[ρσ_Index24];
                    (ρσ_expr_temp = self._context)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key] = arg[(typeof key === "number" && key < 0) ? arg.length + key : key];
                }
            }
            var ρσ_Iter25 = ρσ_Iterable(kwargs);
...
return this.__repr__();
            ...
            function wrap() {
                ...
                return tools.ajax("post", "json", tools.configuration.url + "/api/methods", (function(){
                    ...
                    var ρσ_anonfunc = function (error) {
                        console.error(error);
                        self[ρσ_bound_index(method.name, self)] = method;
                        return self[ρσ_bound_index(method.name, self)].apply(self, args);
                    };
                    if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                        __argnames__ : {value: ["error"]}
                    });
    ...
    (function(){
        ...
        ResUsers.prototype.create = function create() {
            var self = this;
            var values = (arguments[0] === undefined || ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true)) ? create.__defaults__.values : arguments[0];
            var is_client = (arguments[1] === undefined || ( 1 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true)) ? create.__defaults__.is_client : arguments[1];
            var ρσ_kwargs_obj = arguments[arguments.length-1];
            ...
            var result;
            if (values.is_superuser && (self._context.uid !== models.superuser_id && (typeof self._context.uid !== "object" || ρσ_not_equals(self._context.uid, models.superuser_id)))) {
                throw new Exception("Never set anyone except admin as superuser");
            }
            result = (ρσ_expr_temp = self.__super__("create"), ρσ_interpolate_kwargs.call(ρσ_expr_temp, ρσ_expr_temp, [ρσ_desugar_kwargs({values: values, is_client: is_client})]));
            if (typeof window === 'undefined') {
        ...
        if (!ResUsers.prototype.create.__defaults__) Object.defineProperties(ResUsers.prototype.create, {
            __defaults__ : {value: {values:false, is_client:tools.configuration.client}},
            __handles_kwarg_interpolation__ : {value: true},
            __argnames__ : {value: ["values", "is_client"]}
        });
        ResUsers.prototype.write = function write() {
            var self = this;
            var values = (arguments[0] === undefined || ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true)) ? write.__defaults__.values : arguments[0];
            var is_client = (arguments[1] === undefined || ( 1 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true)) ? write.__defaults__.is_client : arguments[1];
            var ρσ_kwargs_obj = arguments[arguments.length-1];
            ...
            return (ρσ_expr_temp = self.__super__("write"), ρσ_interpolate_kwargs.call(ρσ_expr_temp, ρσ_expr_temp, [ρσ_desugar_kwargs({values: values, is_client: is_client})]));
        };
        if (!ResUsers.prototype.write.__defaults__) Object.defineProperties(ResUsers.prototype.write, {
            __defaults__ : {value: {values:false, is_client:tools.configuration.client}},
            __handles_kwarg_interpolation__ : {value: true},
            __argnames__ : {value: ["values", "is_client"]}
        });
...
return this.__repr__();
        ...
        ResUsers.prototype.is_superuser = ρσ_interpolate_kwargs.call(fields, fields.Boolean, [ρσ_desugar_kwargs({string: "Is Superuser"})]);
        ...
        function check_admin() {
            function create_admin() {
                return models.env["res.users"].create((function(){
                    var ρσ_d = {};
                    ρσ_d["name"] = "Administrator";
                    ρσ_d["login"] = "admin";
                    ρσ_d["password"] = admin_password;
                    ρσ_d["is_superuser"] = true;
                    return ρσ_d;
                }).call(this)).then((function() {
                    var ρσ_anonfunc = function (record) {
            ...
            if (!tools.configuration.client) {
                ρσ_interpolate_kwargs.call(models.env["res.users"], models.env["res.users"].with_context, [ρσ_desugar_kwargs({limit: 1})]).search(ρσ_list_decorate([ "is_superuser", "=", true ])).then((function() {
                    var ρσ_anonfunc = function (record) {
                        if (!tools.exist(record.length)) {
                            return create_admin();
                        } else {
                            models.superuser_id = record.id;
                        }
...
return this.__repr__();
    ...
    (function(){
        ...
        function WatsonTeaching() {
            if (this.ρσ_object_id === undefined) Object.defineProperty(this, "ρσ_object_id", {"value":++ρσ_object_counter});
            WatsonTeaching.prototype.__init__.apply(this, arguments);
        }
        ρσ_extends(WatsonTeaching, models.Model);
        WatsonTeaching.prototype.__init__ = function __init__ () {
            models.Model.prototype.__init__ && models.Model.prototype.__init__.apply(this, arguments);
        };
        WatsonTeaching.prototype.upload_watson = api.strict((function() {
            var ρσ_anonfunc = function upload_watson(name, description) {
                var self = this;
                var path, fs, archiver, output, archive;
                path = "C:/CAPTURED_IMAGE";
                teaching.count += 1;
                console.log(teaching.count);
                fs = require("fs");
                archiver = require("archiver");
                output = fs.createWriteStream("./Captured.zip");
                archive = archiver("zip", (function(){
                    var ρσ_d = {};
                    ρσ_d["level"] = 9;
                    return ρσ_d;
                }).call(this));
                archive.pipe(output);
                archive.glob("*CAM" + teaching.count + "*.jpeg", (function(){
                    var ρσ_d = {};
                    ρσ_d["cwd"] = path;
                    return ρσ_d;
                }).call(this));
                return archive.finalize().then(function () {
                    var stream, requests, request, form;
                    stream = (archive.pointer() > 100) ? output : false;
                    if (!stream && ρσ_in("win", require("process").platform)) {
                        return require("child-process-promise").exec("ls sample/*CAM*.jpeg | grep CAM | tail -1").then((function() {
                            var ρσ_anonfunc = function (result) {
                                teaching.count = int(result.stdout.split("CAM")[1].split("_R")[0]) - 1;
                                return self.upload_watson(name, description);
                            };
                            if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                                __argnames__ : {value: ["result"]}
                            });
                    ...
                    request = requests.post((function(){
                        var ρσ_d = {};
                        ρσ_d["url"] = "https://iotm.predictivesolutionsapps.ibmcloud.com/ibm/iotm/service/unLabeledImageZipServlet?user=haekal@iniled.co.id&solution=vi&tenant=TOYOTA&groupType=objectdetection";
                        ρσ_d["headers"] = (function(){
                            var ρσ_d = {};
                            ρσ_d["APIKEY"] = "a8f93678d5004b47bb9102bdd6f7f12268a68ba284214d6181bfccb135c50fd922bf25debfef4de28952a3f8e44c9f5bcb9327a56fb54ebf834c09a120d4e2ce";
                            return ρσ_d;
                        }).call(this);
                        return ρσ_d;
                    }).call(this));
                    form = request.form();
                    form.append("file", fs.createReadStream((!stream) ? "./Archive.zip" : "./Captured.zip"));
                    return request.then((function() {
                        var ρσ_anonfunc = function (body) {
                            var image_zip, request;
                            console.log(body);
                            image_zip = JSON.parse(body).result.imageZip;
                            request = requests.post((function(){
                                var ρσ_d = {};
                                ρσ_d["body"] = JSON.stringify(ρσ_list_decorate([ (function(){
                                    var ρσ_d = {};
                                    ρσ_d["groupName"] = name;
                                    ρσ_d["groupType"] = "objectdetection";
                                    ρσ_d["imageZip"] = image_zip;
                                    return ρσ_d;
                                }).call(this) ]));
                                ρσ_d["url"] = "https://iotm.predictivesolutionsapps.ibmcloud.com/ibm/iotm/service/unLabeledGroup?user=haekal@iniled.co.id&solution=vi&tenant=TOYOTA";
                                ρσ_d["headers"] = (function(){
                                    var ρσ_d = {};
                                    ρσ_d["Content-Type"] = "application/json";
                                    ρσ_d["APIKEY"] = "a8f93678d5004b47bb9102bdd6f7f12268a68ba284214d6181bfccb135c50fd922bf25debfef4de28952a3f8e44c9f5bcb9327a56fb54ebf834c09a120d4e2ce";
                                    return ρσ_d;
                                }).call(this);
                                return ρσ_d;
                            ...
                            return request.then((function() {
                                var ρσ_anonfunc = function (body) {
                                    ...
                                    return requests.put((function(){
                                        var ρσ_d = {};
                                        ρσ_d["body"] = JSON.stringify(ρσ_list_decorate([ {} ]));
                                        ρσ_d["url"] = "https://iotm.predictivesolutionsapps.ibmcloud.com/ibm/iotm/service/unLabeledGroup/" + id + "?user=haekal@iniled.co.id&solution=vi&tenant=TOYOTA&sampleRate=0.25";
                                        ρσ_d["headers"] = (function(){
                                            var ρσ_d = {};
                                            ρσ_d["Content-Type"] = "application/json";
                                            ρσ_d["APIKEY"] = "a8f93678d5004b47bb9102bdd6f7f12268a68ba284214d6181bfccb135c50fd922bf25debfef4de28952a3f8e44c9f5bcb9327a56fb54ebf834c09a120d4e2ce";
        ...
        WatsonTeaching.prototype.__repr__ = function __repr__ () {
            if(models.Model.prototype.__repr__) return models.Model.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        WatsonTeaching.prototype.__str__ = function __str__ () {
            if(models.Model.prototype.__str__) return models.Model.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(WatsonTeaching.prototype, "__bases__", {value: [models.Model]});
        WatsonTeaching.prototype._name = "watson.teaching";
        WatsonTeaching.prototype.name = ρσ_interpolate_kwargs.call(fields, fields.Char, [ρσ_desugar_kwargs({string: "Work Number"})]);
        WatsonTeaching.prototype.submit_date = ρσ_interpolate_kwargs.call(fields, fields.Datetime, [ρσ_desugar_kwargs({string: "Submit Date"})]);
        WatsonTeaching.prototype.raw_data = ρσ_interpolate_kwargs.call(fields, fields.Data, [ρσ_desugar_kwargs({string: "Raw Data"})]);
        ...
        menu.add((function(){
            ...
            ρσ_d["id"] = "teaching";
            ρσ_d["parent"] = "watson";
            ρσ_d["string"] = "Teaching";
            ρσ_d["model"] = "watson.teaching";
            ρσ_d["view_id"] = "watson.teaching.ui";
            ρσ_d["sequence"] = 1;
            return ρσ_d;
        }).call(this));
        menu.add((function(){
            var ρσ_d = {};
            ρσ_d["id"] = "teaching_log";
            ρσ_d["parent"] = "watson";
            ρσ_d["string"] = "Teaching Log";
            ρσ_d["model"] = "watson.teaching";
            ρσ_d["sequence"] = 2;
            return ρσ_d;
        }).call(this));
        ...
        function teaching_init(props) {
            return;
        };
        if (!teaching_init.__argnames__) Object.defineProperties(teaching_init, {
        ...
        view.add((function(){
            ...
            ρσ_d["model"] = "watson.teaching";
            ρσ_d["mode"] = "ui";
            ρσ_d["init"] = teaching_init;
            ρσ_d["string"] = false;
            ρσ_d["arch"] = "\n<watson-teaching/>\n";
            return ρσ_d;
        }).call(this));
        ρσ_modules["watson.teaching"].teaching = teaching;
        ρσ_modules["watson.teaching"].WatsonTeaching = WatsonTeaching;
        ρσ_modules["watson.teaching"].teaching_init = teaching_init;
    })();

    (function(){
        var __name__ = "watson.confirmation";
        var confirmation;
        var models = ρσ_modules["orm.models"];
        ...
        function WatsonConfirmation() {
            if (this.ρσ_object_id === undefined) Object.defineProperty(this, "ρσ_object_id", {"value":++ρσ_object_counter});
            WatsonConfirmation.prototype.__init__.apply(this, arguments);
        }
        ρσ_extends(WatsonConfirmation, models.Model);
        WatsonConfirmation.prototype.__init__ = function __init__ () {
            models.Model.prototype.__init__ && models.Model.prototype.__init__.apply(this, arguments);
        };
        WatsonConfirmation.prototype.score_results = api.strict((function() {
            var ρσ_anonfunc = function score_results() {
                var self = this;
                var directory;
                confirmation.directory = (ρσ_in("win", require("process").platform)) ? "C:/CAPTURED_IMAGE" : "sample/";
                directory = confirmation.directory;
                confirmation.cam += 1;
                return require("child-process-promise").exec("ls " + directory + "/*CAM" + confirmation.cam + "*.txt || ls " + directory + "/*CAM" + (confirmation.cam - 1) + "*.txt").then((function() {
                    var ρσ_anonfunc = function (result) {
                        var filenames;
                        if (!(ρσ_in("CAM" + confirmation.cam, result.stdout))) {
                            confirmation.cam -= 1;
                        }
                        filenames = result.stdout.split(directory).join("").split("\n").slice(0, -1);
                        return require("child-process-promise").exec("cat " + directory + "/*CAM" + confirmation.cam + "*.txt").then((function() {
                            var ρσ_anonfunc = function (result) {
                                var results, files, rotations, journals, index, rotation, journal, file, data, datasets, percentages, percent, score, probable, detection;
                                results = result.stdout.split("\n").slice(0, -1);
                                files = {};
                                confirmation.files = files;
                                rotations = list(range(8 + 1)).slice(1);
                                journals = list(range(5 + 1)).slice(1);
                                index = 0;
                                var ρσ_Iter0 = ρσ_Iterable(filenames);
                                for (var ρσ_Index0 = 0; ρσ_Index0 < ρσ_Iter0.length; ρσ_Index0++) {
                                    file = ρσ_Iter0[ρσ_Index0];
                                    rotation = file.split("_J")[0].split("_R")[1];
                                    journal = file.split("_J")[1].split(".txt")[0];
                                    files[ρσ_bound_index("R" + rotation + "J" + journal, files)] = results[(typeof index === "number" && index < 0) ? results.length + index : index];
                                    index += 1;
                                }
                                data = {};
                                data.labels = (function() {
                                    var ρσ_Iter = ρσ_Iterable(journals), ρσ_Result = [], journal;
                                    for (var ρσ_Index = 0; ρσ_Index < ρσ_Iter.length; ρσ_Index++) {
                                        journal = ρσ_Iter[ρσ_Index];
                                        ρσ_Result.push("J" + journal);
                                    }
                                    ρσ_Result = ρσ_list_constructor(ρσ_Result);
                                    return ρσ_Result;
                                })();
                                data.datasets = ρσ_list_decorate([]);
                                var ρσ_Iter1 = ρσ_Iterable(rotations);
                                for (var ρσ_Index1 = 0; ρσ_Index1 < ρσ_Iter1.length; ρσ_Index1++) {
                                    rotation = ρσ_Iter1[ρσ_Index1];
                                    datasets = ρσ_list_decorate([]);
                                    var ρσ_Iter2 = ρσ_Iterable(journals);
                                    for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
                                        journal = ρσ_Iter2[ρσ_Index2];
                                        percentages = ρσ_list_decorate([]);
                                        percent = 100;
                                        file = files[ρσ_bound_index("R" + rotation + "J" + journal, files)];
                                        if (file) {
                                            score = JSON.parse(file);
                                            var ρσ_Iter3 = ρσ_Iterable(score.detections);
                                            for (var ρσ_Index3 = 0; ρσ_Index3 < ρσ_Iter3.length; ρσ_Index3++) {
                                                detection = ρσ_Iter3[ρσ_Index3];
                                                var ρσ_Iter4 = ρσ_Iterable(detection.probableTypes);
                                                for (var ρσ_Index4 = 0; ρσ_Index4 < ρσ_Iter4.length; ρσ_Index4++) {
                                                    probable = ρσ_Iter4[ρσ_Index4];
                                                    percentages.push(percent - probable.confidence);
                                                }
                                            }
                                            if (percentages) {
                                                percent;
                                                percent = sum(percentages) / percentages.length;
                                            }
                                        } else {
                                            percent = "";
                                        }
                                        if (percent) {
                                            percent = float(percent.toString().slice(0, 5));
                                        }
                                        datasets.push(percent);
                                    }
                                    data.datasets.push((function(){
                                        var ρσ_d = {};
                                        ρσ_d["label"] = "R" + rotation;
                                        ρσ_d["data"] = datasets;
                                        return ρσ_d;
                                    }).call(this));
                                }
                    ...
                    var ρσ_anonfunc = function (error) {
                        if (confirmation.error_count) {
                            confirmation.error_count = 0;
                            throw error;
                        }
                        confirmation.cam = 0;
                        confirmation.error_count += 1;
        ...
        WatsonConfirmation.prototype.confirmation_image = api.strict((function() {
            var ρσ_anonfunc = function confirmation_image(rotation, journal) {
                var self = this;
                var directory;
                directory = confirmation.directory;
                return require("child-process-promise").exec("base64 " + directory + "/*CAM" + confirmation.cam + "*" + rotation + "*" + journal + "*.jpeg", (function(){
                    var ρσ_d = {};
                    ρσ_d["maxBuffer"] = 1024 * 1024 * 10;
                    return ρσ_d;
                }).call(this)).then((function() {
                    var ρσ_anonfunc = function (result) {
                        var score;
                        score = JSON.parse((ρσ_expr_temp = confirmation.files)[ρσ_bound_index(rotation + journal, ρσ_expr_temp)]);
                        score.image = result.stdout;
                        return score;
                    };
                    if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                        __argnames__ : {value: ["result"]}
            ...
            if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                __argnames__ : {value: ["rotation", "journal"]}
            });
            return ρσ_anonfunc;
        })());
        WatsonConfirmation.prototype.__repr__ = function __repr__ () {
            if(models.Model.prototype.__repr__) return models.Model.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        WatsonConfirmation.prototype.__str__ = function __str__ () {
            if(models.Model.prototype.__str__) return models.Model.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(WatsonConfirmation.prototype, "__bases__", {value: [models.Model]});
        WatsonConfirmation.prototype._name = "watson.confirmation";
        WatsonConfirmation.prototype.name = ρσ_interpolate_kwargs.call(fields, fields.Char, [ρσ_desugar_kwargs({string: "Confirmation Number"})]);
        WatsonConfirmation.prototype.submit_date = ρσ_interpolate_kwargs.call(fields, fields.Datetime, [ρσ_desugar_kwargs({string: "Submit Date"})]);
        WatsonConfirmation.prototype.raw_data = ρσ_interpolate_kwargs.call(fields, fields.Data, [ρσ_desugar_kwargs({string: "Raw Data"})]);
        
        

        new WatsonConfirmation;
        menu.add((function(){
            var ρσ_d = {};
            ρσ_d["id"] = "confirmation";
            ρσ_d["parent"] = "watson";
            ρσ_d["string"] = "Confirmation";
            ρσ_d["model"] = "watson.confirmation";
            ρσ_d["view_id"] = "watson.confirmation.result";
            ρσ_d["sequence"] = 3;
            return ρσ_d;
        }).call(this));
        menu.add((function(){
            var ρσ_d = {};
            ρσ_d["id"] = "confirmation_spv";
            ρσ_d["parent"] = "watson";
            ρσ_d["string"] = "Confirmation SPV";
            ρσ_d["model"] = "watson.confirmation";
            ρσ_d["sequence"] = 4;
            return ρσ_d;
        }).call(this));
        function result_init(props) {
            return;
        };
        if (!result_init.__argnames__) Object.defineProperties(result_init, {
            __argnames__ : {value: ["props"]}
        });
        ...
        ρσ_modules["watson.confirmation"].confirmation = confirmation;
        ρσ_modules["watson.confirmation"].WatsonConfirmation = WatsonConfirmation;
        ρσ_modules["watson.confirmation"].result_init = result_init;
    })();

    (function(){
        var __name__ = "watson.modules";
        var watson = ρσ_modules.watson;
        watson.teaching = ρσ_modules["watson.teaching"];

        var watson = ρσ_modules.watson;
        watson.confirmation = ρσ_modules["watson.confirmation"];
    ...
    (function(){
        ...
        var watson = ρσ_modules.watson;
        watson.modules = ρσ_modules["watson.modules"];
    ...
    (function(){
        ...
        http.route("/api/login", (function() {
            var ρσ_anonfunc = function (request, response, next) {
                        ...
                        var ρσ_anonfunc = function (user_id) {
                            ...
                            if (exist(user_id)) {
                                ...
                                if (params.authentication = true) {
                                    ...
                                    response.result.login = ρσ_unpack[0];
                                    response.result.password = ρσ_unpack[1];
            ...
            if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                __argnames__ : {value: ["request", "response", "next"]}
            });
            return ρσ_anonfunc;
        })(), (function() {
            var ρσ_anonfunc = function (request, response, next) {
        ...
        http.route("/api/browse", (function() {
            var ρσ_anonfunc = function (request, response, next) {
                var params;
                if ((response.result.status !== "success" && (typeof response.result.status !== "object" || ρσ_not_equals(response.result.status, "success")))) {
                    next();
                }
                params = request.params;
                if (exist(request.params)) {
                    (ρσ_expr_temp = request.env)[ρσ_bound_index(params.model, ρσ_expr_temp)].sudo(response.result.id).browse(params.ids).then((function() {
                        var ρσ_anonfunc = function (record) {
                            response.result = (function(){
                                var ρσ_d = {};
                                ρσ_d["status"] = "success";
        ...
        http.route("/api/search", (function() {
            var ρσ_anonfunc = function (request, response, next) {
                ...
                if (exist(request.params)) {
                    ...
                    (ρσ_expr_temp = (ρσ_expr_temp = (ρσ_expr_temp = request.env)[ρσ_bound_index(params.model, ρσ_expr_temp)].sudo(response.result.id), ρσ_interpolate_kwargs.call(ρσ_expr_temp, ρσ_expr_temp.with_context, [ρσ_desugar_kwargs(options)])), ρσ_expr_temp.search.apply(ρσ_expr_temp, params.args)).then((function() {
                        var ρσ_anonfunc = function (record) {
                            response.result = (function(){
                                var ρσ_d = {};
                                ρσ_d["status"] = "success";
        ...
        http.route("/api/create", (function() {
            var ρσ_anonfunc = function (request, response, next) {
                ...
                params = request.params;
                if (exist(request.params)) {
                    (ρσ_expr_temp = request.env)[ρσ_bound_index(params.model, ρσ_expr_temp)].sudo(response.result.id).create(params.values).then((function() {
                        var ρσ_anonfunc = function (record) {
                            response.result = (function(){
                                var ρσ_d = {};
                                ρσ_d["status"] = "success";
                        ...
                        var ρσ_anonfunc = function (record) {
                            ...
                            return record[ρσ_bound_index(params.method, record)].apply(record, args).then((function() {
                                var ρσ_anonfunc = function (result) {
                                    ...
                                    if ((result instanceof env.Model === false || typeof result instanceof env.Model === "object" && ρσ_equals(result instanceof env.Model, false))) {
        ...
        if (!configuration.serverless) {
            ...
            serverless_route = {};
            var ρσ_Iter1 = ρσ_Iterable(http._controllers);
            for (var ρσ_Index1 = 0; ρσ_Index1 < ρσ_Iter1.length; ρσ_Index1++) {
                route = ρσ_Iter1[ρσ_Index1];
                console.log(route);
                serverless_route[(typeof route === "number" && route < 0) ? serverless_route.length + route : route] = (function() {
                    var ρσ_anonfunc = function (request, response, route) {
                        var functions, index;
                        functions = ρσ_list_decorate([]);
                        ((function() {
                            var ρσ_anonfunc = function recurse(methods) {
                                var method;
                                var ρσ_Iter2 = ρσ_Iterable(methods);
                                for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
                                    method = ρσ_Iter2[ρσ_Index2];
                        ...
                        function next(arg) {
                            ...
                            if (index < functions.length && exist(functions[(typeof index === "number" && index < 0) ? functions.length + index : index])) {
                                ...
                                functions[(typeof index === "number" && index < 0) ? functions.length + index : index](request, response, next);
                            }
                        };
                    ...
                    if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                        __argnames__ : {value: ["request", "response", "route"]}
                    });
                    return ρσ_anonfunc;
                })();
            }
            exports.api = (function() {
                var ρσ_anonfunc = function (request, response) {
                ...
                if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                    __argnames__ : {value: ["request", "response"]}
                });
                return ρσ_anonfunc;
            })();
        }

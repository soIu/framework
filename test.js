...
var str = ρσ_str, repr = ρσ_repr;;
    ...
    (function(){
        var __name__ = "pouchdb";
        var PouchDB, db;
        PouchDB = require("pouchdb-core");
        PouchDB.plugin(require("pouchdb-adapter-memory"));
        PouchDB.plugin(require("relational-pouch"));
        db = PouchDB("test", (function(){
            var ρσ_d = {};
            ρσ_d["adapter"] = "memory";
            return ρσ_d;
        }).call(this));
        ρσ_modules.pouchdb.PouchDB = PouchDB;
        ρσ_modules.pouchdb.db = db;
    })();

    (function(){
        var __name__ = "models";
        var db = ρσ_modules.pouchdb.db;
        ...
        if (!Model.prototype.schema.__argnames__) Object.defineProperties(Model.prototype.schema, {
            __argnames__ : {value: []}
        });
        Model.prototype.__init__ = function __init__() {
            var self = this;
            db.setSchema(ρσ_list_decorate([ self.schema() ]));
        };
        ...
        ρσ_modules.models.Model = Model;
    })();

    (function(){
        var __name__ = "orm";
        var models = ρσ_modules.models;
    ...
    (function(){
        ...
        function SaleOrder() {
            if (this.ρσ_object_id === undefined) Object.defineProperty(this, "ρσ_object_id", {"value":++ρσ_object_counter});
            SaleOrder.prototype.__init__.apply(this, arguments);
        }
        ρσ_extends(SaleOrder, models.Model);
        SaleOrder.prototype.__init__ = function __init__ () {
            models.Model.prototype.__init__ && models.Model.prototype.__init__.apply(this, arguments);
        };
        SaleOrder.prototype.__repr__ = function __repr__ () {
            if(models.Model.prototype.__repr__) return models.Model.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        SaleOrder.prototype.__str__ = function __str__ () {
            if(models.Model.prototype.__str__) return models.Model.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(SaleOrder.prototype, "__bases__", {value: [models.Model]});
        SaleOrder.prototype._name = "sale.order";
        _fields["name"] = "Test";

        print((new SaleOrder)._inherit);
    })();
})();

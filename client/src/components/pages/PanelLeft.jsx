...
export default () => (
  <Page>
    ...
    <Button fill onClick={async () => api.globals.InstallPromp.prompt() || (await api.globals.InstallPromp.userChoice === 'accepted') && window.location.reload()} style={{display: api.globals.InstallPrompt ? 'inline-block' : 'none', margin: '10px'}}>Install</Button>

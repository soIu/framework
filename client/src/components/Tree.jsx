...
export default class Tree extends React.Component {
  ...
  render(props) {
    ...
    const grid = (
      <div className="card-body" style={{height: this.state.records.length * 48 + 112 + editableHeight() <= 440 ? this.state.records.length * 48 + 112 + editableHeight() + 'px' : '67vh', ...((props.invisible instanceof Function ? props.invisible(window.models.env.context.active_id) : props.invisible) ? {position: 'absolute', left: '-9999px', top: '-9999px'} : {})}}>
